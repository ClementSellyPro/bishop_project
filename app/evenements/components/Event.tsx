export default function Event() {
  return (
    ...
    >
      <div className="ml-0 lg:ml-20 mt-14 w-11/12 md:w-6/12 lg:w-9/12 h-10/12 relative rounded-4xl px-4 lg:px-18 py-8 lg:py-12 border-2 border-[#229B3C]  bg-[#282828]">
